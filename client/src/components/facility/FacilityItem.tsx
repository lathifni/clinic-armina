...
export const FacilityItem = ( ) => {
  ...
  return (data?.data?.map((facility:FacilityItemsSchema)=>(
    <article key={facility.id} className="flex lg:even:flex-row-reverse flex-col lg:items-start justify-center items-center  lg:flex-row rounded-3xl border-4 border-lightGreen shadow-[0_4px_4px_0px_rgba(0,0,0,0.25)] p-8 gap-8 bg-blueLigth">
